#include "../../../include/ccxt/exchanges/ws/htx_ws.h"
...
HTXWS::HTXWS(boost::asio::io_context& ioc, boost::asio::ssl::context& ctx, HTX& exchange)
...
void HTXWS::watchTicker(const std::string& symbol) {
...
void HTXWS::watchOrderBook(const std::string& symbol, const std::string& limit) {
    auto market = exchange_.market(symbol);
...
void HTXWS::watchTrades(const std::string& symbol) {
    auto market = exchange_.market(symbol);
...
void HTXWS::watchOHLCV(const std::string& symbol, const std::string& timeframe) {
    auto market = exchange_.market(symbol);
...
std::string HTXWS::sign(const std::string& payload) {
    auto apiSecret = exchange_.getApiSecret();
...
void HTXWS::handleMessage(const std::string& message) {
    try {
...
void HTXWS::handleTicker(const nlohmann::json& data) {
    Ticker ticker;
...
void HTXWS::handleOrderBook(const nlohmann::json& data) {
    OrderBook orderBook;
...
void HTXWS::handleTrade(const nlohmann::json& data) {
...
void HTXWS::handleOHLCV(const nlohmann::json& data) {
    OHLCV ohlcv;
...
void HTXWS::handleBalance(const nlohmann::json& data) {
    try {
        Balance balance;
...
void HTXWS::handleOrder(const nlohmann::json& data) {
    try {
        Order order;
...
void HTXWS::handleMyTrade(const nlohmann::json& data) {
    try {
        Trade trade;
