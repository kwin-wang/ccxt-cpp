#include "../../../include/ccxt/exchanges/ws/huobi_ws.h"
...
HuobiWS::HuobiWS(boost::asio::io_context& ioc, boost::asio::ssl::context& ctx, Huobi& exchange)
...
void HuobiWS::watchTicker(const std::string& symbol) {
...
void HuobiWS::watchOrderBook(const std::string& symbol, const std::string& limit) {
    auto market = exchange_.market(symbol);
...
void HuobiWS::watchTrades(const std::string& symbol) {
    auto market = exchange_.market(symbol);
...
void HuobiWS::watchOHLCV(const std::string& symbol, const std::string& timeframe) {
    auto market = exchange_.market(symbol);
...
std::string HuobiWS::sign(const std::string& payload) {
    auto apiSecret = exchange_.getApiSecret();
...
void HuobiWS::handleMessage(const std::string& message) {
    try {
...
void HuobiWS::handleTicker(const nlohmann::json& data) {
    Ticker ticker;
...
void HuobiWS::handleOrderBook(const nlohmann::json& data) {
    OrderBook orderBook;
...
void HuobiWS::handleTrade(const nlohmann::json& data) {
...
void HuobiWS::handleOHLCV(const nlohmann::json& data) {
    OHLCV ohlcv;
...
void HuobiWS::handleBalance(const nlohmann::json& data) {
    try {
        Balance balance;
...
void HuobiWS::handleOrder(const nlohmann::json& data) {
    try {
        Order order;
...
void HuobiWS::handleMyTrade(const nlohmann::json& data) {
    try {
        Trade trade;
