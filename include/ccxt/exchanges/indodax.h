...
class Indodax : public Exchange {
public:
    Indodax();
    ~Indodax() override = default;
...
private:
    ...
    std::string getIndodaxSymbol(const std::string& symbol);
    std::string getCommonSymbol(const std::string& indodaxSymbol);
