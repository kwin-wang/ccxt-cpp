...
class BTCBOX : public Exchange {
public:
    BTCBOX();
    ~BTCBOX() override = default;
...
private:
    ...
    String getBTCBOXSymbol(const String& symbol);
    String getCommonSymbol(const String& btcboxSymbol);
    ...
    String createSignature(const String& path, const json& params);
    String getNonce();
