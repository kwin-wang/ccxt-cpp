...
private:
    ...
    std::string getBTCBOXSymbol(const std::string& symbol);
    std::string getCommonSymbol(const std::string& btcboxSymbol);
    ...
    std::string createSignature(const std::string& path, const json& params);
    std::string getNonce();
