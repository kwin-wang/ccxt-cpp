...
class Btcturk : public Exchange {
public:
    Btcturk();
    ~Btcturk() override = default;
...
private:
    ...
    std::string getBtcturkSymbol(const std::string& symbol);
    std::string getCommonSymbol(const std::string& btcturkSymbol);
