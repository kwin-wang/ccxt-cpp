...
class Novadax : public Exchange {
public:
    Novadax();
    ~Novadax() override = default;
...
private:
    ...
    std::string getNovadaxSymbol(const std::string& symbol);
    std::string getCommonSymbol(const std::string& novadaxSymbol);
