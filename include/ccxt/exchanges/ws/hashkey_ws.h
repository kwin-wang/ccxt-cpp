#ifndef CCXT_HASHKEY_WS_H
#define CCXT_HASHKEY_WS_H
...
class HashkeyWS : public WebSocketClient {
public:
    HashkeyWS(boost::asio::io_context& ioc, boost::asio::ssl::context& ctx, Hashkey& exchange);
