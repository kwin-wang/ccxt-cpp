#ifndef CCXT_PROBIT_WS_H
#define CCXT_PROBIT_WS_H
...
class ProbitWS : public WebSocketClient {
public:
    ProbitWS(boost::asio::io_context& ioc, boost::asio::ssl::context& ctx, Probit& exchange);
