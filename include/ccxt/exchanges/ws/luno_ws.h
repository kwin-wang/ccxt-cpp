#ifndef CCXT_LUNO_WS_H
#define CCXT_LUNO_WS_H
...
class LunoWS : public WebSocketClient {
public:
    LunoWS(boost::asio::io_context& ioc, boost::asio::ssl::context& ctx, Luno& exchange);
