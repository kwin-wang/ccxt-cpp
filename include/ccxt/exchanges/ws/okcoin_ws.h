#ifndef CCXT_OKCOIN_WS_H
#define CCXT_OKCOIN_WS_H

#include "ccxt/websocket_client.h"
#include "ccxt/exchanges/okcoin.h"
#include <map>
#include <string>
#include <vector>
...
class OKCoinWS : public WebSocketClient {
public:
    OKCoinWS(boost::asio::io_context& ioc, boost::asio::ssl::context& ctx, OKCoin& exchange);
...
private:
    ...
    void handleLoginMessage(const nlohmann::json& data);
