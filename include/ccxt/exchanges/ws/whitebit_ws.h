#ifndef CCXT_WHITEBIT_WS_H
#define CCXT_WHITEBIT_WS_H
...
class WhiteBitWS : public WebSocketClient {
public:
    WhiteBitWS(boost::asio::io_context& ioc, boost::asio::ssl::context& ctx, WhiteBit& exchange);
