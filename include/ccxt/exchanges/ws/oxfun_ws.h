#ifndef CCXT_OXFUN_WS_H
#define CCXT_OXFUN_WS_H

#include "ccxt/exchanges/oxfun.h"
...
class OxFunWS : public WebSocketClient {
public:
    OxFunWS(boost::asio::io_context& ioc, boost::asio::ssl::context& ctx, OxFun& exchange);
