#ifndef CCXT_HOLLEX_WS_H
#define CCXT_HOLLEX_WS_H
...
class HollexWS : public WebSocketClient {
public:
    HollexWS(boost::asio::io_context& ioc, boost::asio::ssl::context& ctx, Hollex& exchange);
