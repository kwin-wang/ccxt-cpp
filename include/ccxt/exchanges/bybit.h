...
public:
    ...
    json setLeverage(const String& symbol, double longLeverage, double shortLeverage = 0, const json& params = json::object());
...
private:
    ...
    String createSignature(const String& timestamp, const String& method,
                         ...
                         const String& body = "");
    String getBybitSymbol(const String& symbol);
    String getCommonSymbol(const String& bybitSymbol);
    ...
    String defaultType;  // "spot", "linear", "inverse"
};
