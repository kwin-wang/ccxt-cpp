...
public:
    ...
    json fetchFuturesPosition(const std::string& symbol = "", const json& params = json::object());
    json fetchFuturesPositions(const std::vector<std::string>& symbols = {}, const json& params = json::object());
    json fetchFuturesFundingRate(const std::string& symbol, const json& params = json::object());
    json fetchFuturesFundingRateHistory(const std::string& symbol = "", int since = 0, int limit = 0, const json& params = json::object());
    json setLeverage(const std::string& symbol, int leverage, const json& params = json::object());
    ...
    json createOptionsOrder(const std::string& symbol, const std::string& type, const std::string& side,
                         double amount, double price = 0, const json& params = json::object());
    json cancelOptionsOrder(const std::string& id, const std::string& symbol = "", const json& params = json::object());
    json fetchOptionsPosition(const std::string& symbol = "", const json& params = json::object());
    json fetchOptionsPositions(const std::vector<std::string>& symbols = {}, const json& params = json::object());
...
private:
    ...
    std::string getBtcexSymbol(const std::string& symbol);
    std::string getCommonSymbol(const std::string& btcexSymbol);
