...
class Bitso : public Exchange {
public:
    Bitso();
    ~Bitso() override = default;
...
private:
    ...
    std::string getBitsoSymbol(const std::string& symbol);
    std::string getCommonSymbol(const std::string& bitsoSymbol);
