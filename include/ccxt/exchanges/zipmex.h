...
class Zipmex : public Exchange {
public:
    Zipmex();
    ~Zipmex() override = default;
    ...
    // Margin Trading
    nlohmann::json fetch_leverage_tiers();
    nlohmann::json fetch_market_leverage_tiers(const std::string& symbol);
