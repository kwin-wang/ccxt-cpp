#ifndef CCXT_EXCHANGE_HYPERLIQUID_H
#define CCXT_EXCHANGE_HYPERLIQUID_H
...
class hyperliquid : public ExchangeImpl {
public:
    hyperliquid(const Config& config = Config());
    ~hyperliquid() = default;
...
#endif // CCXT_EXCHANGE_HYPERLIQUID_H
