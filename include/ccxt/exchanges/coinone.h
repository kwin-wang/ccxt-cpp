...
public:
    ...
    json fetchLimitOrders(const String& symbol = "", int since = 0, int limit = 0, const json& params = json::object());
    json fetchMarketOrders(const String& symbol = "", int since = 0, int limit = 0, const json& params = json::object());
    json fetchTransactionHistory(const String& code = "", int since = 0, int limit = 0, const json& params = json::object());
...
private:
    ...
    String getCoinoneSymbol(const String& symbol);
    String getCommonSymbol(const String& coinoneSymbol);
