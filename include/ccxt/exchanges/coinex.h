...
public:
    ...
    nlohmann::json create_margin_order(const std::string& symbol, const std::string& type,
                                     const std::string& side, double amount,
                                     double price = 0);
    nlohmann::json borrow_margin(const std::string& code, double amount, const std::string& symbol = "");
    nlohmann::json repay_margin(const std::string& code, double amount, const std::string& symbol = "");
