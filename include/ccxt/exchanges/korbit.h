...
public:
    ...
    json fetchUserTransactions(const String& symbol = "", int since = 0, int limit = 0, const json& params = json::object());
...
private:
    ...
    String getKorbitSymbol(const String& symbol);
    String getCommonSymbol(const String& korbitSymbol);
