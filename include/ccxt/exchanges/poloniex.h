...
public:
    ...
    json fetchLeverageTiers(const std::vector<std::string>& symbols = {}, const json& params = json::object());
    json fetchPositions(const std::vector<std::string>& symbols = {}, const json& params = json::object());
...
private:
    ...
    std::string getPoloniexSymbol(const std::string& symbol);
    std::string getCommonSymbol(const std::string& poloniexSymbol);
    ...
    std::string getNonce();
    std::string createSignature(const std::string& path, const std::string& nonce, const json& body);
