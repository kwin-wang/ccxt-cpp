...
public:
    ...
    json fetchCurrencyInfo(const String& code, const json& params = json::object());
...
private:
    ...
    String getSTEXSymbol(const String& symbol);
    String getCommonSymbol(const String& stexSymbol);
