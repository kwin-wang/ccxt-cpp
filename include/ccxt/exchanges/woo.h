...
public:
    ...
    json createMarketSellOrderWithCost(const String& symbol, double cost,
                                     const json& params = json::object()) override;
    json createTakeProfitOrder(const String& symbol, const String& type, const String& side,
                             double amount, double price = 0, const json& params = json::object());
    json createStopLossOrder(const String& symbol, const String& type, const String& side,
                           double amount, double price = 0, const json& params = json::object());
    json createTrailingAmountOrder(const String& symbol, const String& type, const String& side,
                                 double amount, double trailingAmount, const json& params = json::object());
    json createTrailingPercentOrder(const String& symbol, const String& type, const String& side,
    ...
    json fetchConvertQuote(const String& fromCurrency, const String& toCurrency,
                         double amount, const json& params = json::object());
    json createConvertTrade(const String& fromCurrency, const String& toCurrency,
                          double amount, const json& params = json::object());
    json fetchConvertTrade(const String& id, const json& params = json::object());
    json fetchConvertTradeHistory(const String& fromCurrency = "", const String& toCurrency = "",
    ...
    std::future<json> createMarketSellOrderWithCostAsync(const String& symbol, double cost,
                                                       const json& params = json::object());
    std::future<json> createTakeProfitOrderAsync(const String& symbol, const String& type,
                                               const String& side, double amount, double price = 0,
                                               const json& params = json::object());
    std::future<json> createStopLossOrderAsync(const String& symbol, const String& type,
                                             const String& side, double amount, double price = 0,
                                             const json& params = json::object());
    std::future<json> createTrailingAmountOrderAsync(const String& symbol, const String& type,
                                                   const String& side, double amount,
                                                   double trailingAmount,
                                                   const json& params = json::object());
    std::future<json> createTrailingPercentOrderAsync(const String& symbol, const String& type,
                                                    const String& side, double amount,
    ...
    std::future<json> fetchConvertCurrenciesAsync(const json& params = json::object());
    std::future<json> fetchConvertQuoteAsync(const String& fromCurrency,
                                           const String& toCurrency,
                                           double amount,
                                           const json& params = json::object());
    std::future<json> createConvertTradeAsync(const String& fromCurrency,
                                            const String& toCurrency,
                                            double amount,
                                            const json& params = json::object());
    std::future<json> fetchConvertTradeAsync(const String& id,
                                           const json& params = json::object());
    std::future<json> fetchConvertTradeHistoryAsync(const String& fromCurrency = "",
                                                  const String& toCurrency = "",
