...
public:
    ...
    AsyncPullType createMarketSellOrderWithCostAsync(const String& symbol, double cost,
                                                       const json& params = json::object());
    AsyncPullType createTakeProfitOrderAsync(const String& symbol, const String& type,
                                               const String& side, double amount, double price = 0,
                                               const json& params = json::object());
    AsyncPullType createStopLossOrderAsync(const String& symbol, const String& type,
                                             const String& side, double amount, double price = 0,
                                             const json& params = json::object());
    AsyncPullType createTrailingAmountOrderAsync(const String& symbol, const String& type,
                                                   const String& side, double amount,
                                                   double trailingAmount,
                                                   const json& params = json::object());
    AsyncPullType createTrailingPercentOrderAsync(const String& symbol, const String& type,
                                                    const String& side, double amount,
    ...
    AsyncPullType fetchConvertQuoteAsync(const String& fromCurrency,
                                           const String& toCurrency,
                                           double amount,
                                           const json& params = json::object());
    AsyncPullType createConvertTradeAsync(const String& fromCurrency,
                                            const String& toCurrency,
                                            double amount,
                                            const json& params = json::object());
    AsyncPullType fetchConvertTradeAsync(const String& id,
                                           const json& params = json::object());
    AsyncPullType fetchConvertTradeHistoryAsync(const String& fromCurrency = "",
                                                  const String& toCurrency = "",
