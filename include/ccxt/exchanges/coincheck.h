...
public:
    ...
    json createLeverageOrder(const String& symbol, const String& type, const String& side,
                           double amount, double price = 0, const json& params = json::object());
    json cancelLeverageOrder(const String& id, const String& symbol = "", const json& params = json::object());
    json fetchLeveragePositions(const json& params = json::object());
    json fetchLeverageOrders(const String& symbol = "", int since = 0, int limit = 0, const json& params = json::object());

    // Async Leverage Trading API
    boost::future<json> fetchLeverageBalanceAsync(const json& params = json::object());
    boost::future<json> createLeverageOrderAsync(const String& symbol, const String& type, const String& side,
                                               double amount, double price = 0, const json& params = json::object());
    boost::future<json> cancelLeverageOrderAsync(const String& id, const String& symbol = "", const json& params = json::object());
    boost::future<json> fetchLeveragePositionsAsync(const json& params = json::object());
    boost::future<json> fetchLeverageOrdersAsync(const String& symbol = "", int since = 0, int limit = 0, const json& params = json::object());
...
private:
    ...
    String getCoincheckSymbol(const String& symbol);
    String getCommonSymbol(const String& coincheckSymbol);
