...
private:
    ...
    String getBittrexSymbol(const String& symbol);
    String getCommonSymbol(const String& bittrexSymbol);
    ...
    String createSignature(const String& timestamp, const String& uri,
