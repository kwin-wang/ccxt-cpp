...
public:
    ...
    json fetchRequiredIds(const json& params = json::object());
    json fetchPaymentMethods(const json& params = json::object());
    json fetchDepositMethods(const json& params = json::object());
    json fetchWithdrawMethods(const json& params = json::object());
    json fetchTransactions(const String& code = "", int since = 0, int limit = 0, const json& params = json::object());
    json fetchOrderTrades(const String& id, const String& symbol = "", const json& params = json::object());
    json fetchUserTrades(const String& symbol = "", int since = 0, int limit = 0, const json& params = json::object());
...
private:
    ...
    String getExmoSymbol(const String& symbol);
    String getCommonSymbol(const String& exmoSymbol);
