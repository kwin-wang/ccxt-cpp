...
public:
    ...
    json fetchTradingLimits(const String& symbol, const json& params = json::object());
    json fetchMarginRatio(const String& symbol, const json& params = json::object());
...
private:
    ...
    String getGopaxSymbol(const String& symbol);
    String getCommonSymbol(const String& gopaxSymbol);
