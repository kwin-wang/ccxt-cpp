...
class Bitopro : public Exchange {
public:
    Bitopro();
    ~Bitopro() override = default;
...
private:
    ...
    std::string getBitoproSymbol(const std::string& symbol);
    std::string getCommonSymbol(const std::string& bitoproSymbol);
