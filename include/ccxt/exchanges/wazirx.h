...
public:
    ...
    json fetchFundingLimits(const json& params = json::object());
...
private:
    ...
    String getWazirXSymbol(const String& symbol);
    String getCommonSymbol(const String& wazirxSymbol);
