...
class FMFW : public Exchange {
public:
    FMFW();
    ~FMFW() override = default;
...
private:
    ...
    std::string getFMFWSymbol(const std::string& symbol);
    std::string getCommonSymbol(const std::string& fmfwSymbol);
    ...
    bool hasMultipleOrderTypes;
    bool hasMarginTrading;
    bool hasFuturesTrading;
};
