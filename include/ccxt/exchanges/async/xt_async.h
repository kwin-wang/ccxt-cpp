#ifndef CCXT_ASYNC_XT_ASYNC_H
#define CCXT_ASYNC_XT_ASYNC_H
...
class XTAsync : public AsyncExchange, public xt {
public:
    XTAsync(const boost::asio::io_context& context, const Config& config);
