#ifndef CCXT_ASYNC_KUNA_ASYNC_H
#define CCXT_ASYNC_KUNA_ASYNC_H
...
class KunaAsync : public AsyncExchange, public kuna {
public:
    KunaAsync(const boost::asio::io_context& context, const Config& config);
    ...
    boost::future<std::vector<std::string>> fetch_trading_pairs_async();
