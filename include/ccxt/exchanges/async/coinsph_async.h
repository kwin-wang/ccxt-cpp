#ifndef CCXT_EXCHANGES_ASYNC_COINSPH_ASYNC_H
#define CCXT_EXCHANGES_ASYNC_COINSPH_ASYNC_H
...
class CoinsPHAsync : public AsyncExchange, public coinsph {
public:
    explicit CoinsPHAsync(const boost::asio::io_context& context);
    ~CoinsPHAsync() override = default;
...
#endif // CCXT_EXCHANGES_ASYNC_COINSPH_ASYNC_H
