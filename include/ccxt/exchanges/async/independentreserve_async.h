#ifndef CCXT_ASYNC_INDEPENDENTRESERVE_ASYNC_H
#define CCXT_ASYNC_INDEPENDENTRESERVE_ASYNC_H
...
class IndependentReserveAsync : public AsyncExchange, public independentreserve {
public:
    IndependentReserveAsync(const boost::asio::io_context& context, const Config& config);
...
#endif // CCXT_ASYNC_INDEPENDENTRESERVE_ASYNC_H
