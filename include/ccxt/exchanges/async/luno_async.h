#ifndef CCXT_ASYNC_LUNO_ASYNC_H
#define CCXT_ASYNC_LUNO_ASYNC_H
...
class LunoAsync : public AsyncExchange, public luno {
public:
    LunoAsync(const boost::asio::io_context& context, const Config& config);
