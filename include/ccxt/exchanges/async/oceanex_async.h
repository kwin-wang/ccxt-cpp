#ifndef CCXT_ASYNC_OCEANEX_ASYNC_H
#define CCXT_ASYNC_OCEANEX_ASYNC_H
...
class OceanexAsync : public AsyncExchange, public oceanex {
public:
    OceanexAsync(const boost::asio::io_context& context, const Config& config);
    ...
    boost::future<std::vector<std::string>> fetch_orders_async(const std::optional<std::string>& symbol = std::nullopt,
                                                             const std::optional<long long>& since = std::nullopt,
                                                             const std::optional<int>& limit = std::nullopt);
    boost::future<std::string> fetch_order_book_ticker_async(const std::string& symbol);
...
#endif // CCXT_ASYNC_OCEANEX_ASYNC_H
