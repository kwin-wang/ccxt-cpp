#ifndef CCXT_ASYNC_VERTEX_ASYNC_H
#define CCXT_ASYNC_VERTEX_ASYNC_H
...
class VertexAsync : public AsyncExchange, public vertex {
public:
    VertexAsync(const boost::asio::io_context& context, const Config& config);
...
#endif // CCXT_ASYNC_VERTEX_ASYNC_H
