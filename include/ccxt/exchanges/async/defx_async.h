#ifndef CCXT_EXCHANGES_ASYNC_DEFX_ASYNC_H
#define CCXT_EXCHANGES_ASYNC_DEFX_ASYNC_H
...
class DefxAsync : public AsyncExchange, public defx {
public:
    explicit DefxAsync(const boost::asio::io_context& context);
    ~DefxAsync() override = default;
...
#endif // CCXT_EXCHANGES_ASYNC_DEFX_ASYNC_H
