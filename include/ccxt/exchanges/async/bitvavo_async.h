#ifndef CCXT_ASYNC_BITVAVO_ASYNC_H
#define CCXT_ASYNC_BITVAVO_ASYNC_H
...
class BitvavoAsync : public AsyncExchange, public bitvavo {
public:
    BitvavoAsync(const boost::asio::io_context& context, const Config& config);
...
#endif // CCXT_ASYNC_BITVAVO_ASYNC_H
