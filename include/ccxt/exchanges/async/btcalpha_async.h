#ifndef CCXT_BTCALPHA_ASYNC_H
#define CCXT_BTCALPHA_ASYNC_H
...
class BtcalphaAsync : public ExchangeAsync, public Btcalpha {
public:
    explicit BtcalphaAsync(const boost::asio::io_context& context);
    ~BtcalphaAsync() = default;
