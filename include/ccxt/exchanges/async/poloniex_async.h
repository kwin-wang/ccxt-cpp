#ifndef CCXT_ASYNC_POLONIEX_ASYNC_H
#define CCXT_ASYNC_POLONIEX_ASYNC_H
...
class PoloniexAsync : public AsyncExchange, public poloniex {
public:
    PoloniexAsync(const boost::asio::io_context& context, const Config& config);
...
#endif // CCXT_ASYNC_POLONIEX_ASYNC_H
