#ifndef CCXT_ASYNC_WOOFIPRO_ASYNC_H
#define CCXT_ASYNC_WOOFIPRO_ASYNC_H
...
class WooFiProAsync : public AsyncExchange, public woofipro {
public:
    WooFiProAsync(const boost::asio::io_context& context, const Config& config);
...
#endif // CCXT_ASYNC_WOOFIPRO_ASYNC_H
