#ifndef CCXT_ASYNC_ZONDA_ASYNC_H
#define CCXT_ASYNC_ZONDA_ASYNC_H
...
class ZondaAsync : public AsyncExchange, public zonda {
public:
    ZondaAsync(const boost::asio::io_context& context, const Config& config);
...
#endif // CCXT_ASYNC_ZONDA_ASYNC_H
