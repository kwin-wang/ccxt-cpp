#ifndef CCXT_ASYNC_INDODAX_ASYNC_H
#define CCXT_ASYNC_INDODAX_ASYNC_H
...
class IndodaxAsync : public AsyncExchange, public indodax {
public:
    IndodaxAsync(const boost::asio::io_context& context, const Config& config);
    ...
    boost::future<std::vector<std::string>> fetch_trading_fees_async() override;
    boost::future<std::vector<std::string>> fetch_funding_history_async(const std::optional<std::string>& code = std::nullopt,
                                                                      const std::optional<long long>& since = std::nullopt,
                                                                      const std::optional<int>& limit = std::nullopt) override;
...
#endif // CCXT_ASYNC_INDODAX_ASYNC_H
