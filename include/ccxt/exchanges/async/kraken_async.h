#ifndef CCXT_ASYNC_KRAKEN_ASYNC_H
#define CCXT_ASYNC_KRAKEN_ASYNC_H
...
class KrakenAsync : public AsyncExchange, public kraken {
public:
    KrakenAsync(const boost::asio::io_context& context, const Config& config);
...
#endif // CCXT_ASYNC_KRAKEN_ASYNC_H
