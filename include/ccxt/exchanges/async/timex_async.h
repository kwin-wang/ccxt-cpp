#ifndef CCXT_ASYNC_TIMEX_ASYNC_H
#define CCXT_ASYNC_TIMEX_ASYNC_H
...
class TimexAsync : public AsyncExchange, public timex {
public:
    TimexAsync(const boost::asio::io_context& context, const Config& config);
    ...
    boost::future<std::vector<std::string>> fetch_orders_by_status_async(const std::string& status,
...
#endif // CCXT_ASYNC_TIMEX_ASYNC_H
