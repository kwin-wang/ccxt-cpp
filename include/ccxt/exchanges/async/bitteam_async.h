#ifndef CCXT_BITTEAM_ASYNC_H
#define CCXT_BITTEAM_ASYNC_H
...
class BitteamAsync : public ExchangeAsync, public Bitteam {
public:
    explicit BitteamAsync(const boost::asio::io_context& context);
    ~BitteamAsync() = default;
