#ifndef CCXT_ASYNC_NDAX_ASYNC_H
#define CCXT_ASYNC_NDAX_ASYNC_H
...
class NdaxAsync : public AsyncExchange, public ndax {
public:
    NdaxAsync(const boost::asio::io_context& context, const Config& config);
