#ifndef CCXT_ASYNC_NOVADAX_ASYNC_H
#define CCXT_ASYNC_NOVADAX_ASYNC_H
...
class NovadaxAsync : public AsyncExchange, public novadax {
public:
    NovadaxAsync(const boost::asio::io_context& context, const Config& config);
...
#endif // CCXT_ASYNC_NOVADAX_ASYNC_H
