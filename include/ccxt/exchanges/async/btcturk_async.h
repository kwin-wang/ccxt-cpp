#ifndef CCXT_BTCTURK_ASYNC_H
#define CCXT_BTCTURK_ASYNC_H

#include "ccxt/exchanges/async/exchange_async.h"
#include "ccxt/exchanges/btcturk.h"

namespace ccxt {

class BtcturkAsync : public ExchangeAsync, public Btcturk {
public:
    explicit BtcturkAsync(const boost::asio::io_context& context);
    ~BtcturkAsync() = default;
