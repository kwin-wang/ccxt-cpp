#ifndef CCXT_ASYNC_HITBTC3_ASYNC_H
#define CCXT_ASYNC_HITBTC3_ASYNC_H
...
class HitBTC3Async : public AsyncExchange, public hitbtc3 {
public:
    HitBTC3Async(const boost::asio::io_context& context, const Config& config);
    ...
    boost::future<std::string> fetch_funding_rates_async(const std::vector<std::string>& symbols = {});
    boost::future<std::string> fetch_funding_rate_async(const std::string& symbol);
    boost::future<std::vector<std::string>> fetch_positions_async(const std::vector<std::string>& symbols = {});
    boost::future<std::string> set_leverage_async(const std::string& symbol, double leverage);
    boost::future<std::string> fetch_leverage_tiers_async(const std::vector<std::string>& symbols = {});
...
#endif // CCXT_ASYNC_HITBTC3_ASYNC_H
