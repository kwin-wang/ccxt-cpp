#ifndef CCXT_ASYNC_UPBIT_ASYNC_H
#define CCXT_ASYNC_UPBIT_ASYNC_H
...
class UpbitAsync : public AsyncExchange, public upbit {
public:
    UpbitAsync(const boost::asio::io_context& context, const Config& config);
...
#endif // CCXT_ASYNC_UPBIT_ASYNC_H
