#ifndef CCXT_ASYNC_TRADEOGRE_ASYNC_H
#define CCXT_ASYNC_TRADEOGRE_ASYNC_H
...
class TradeOgreAsync : public AsyncExchange, public tradeogre {
public:
    TradeOgreAsync(const boost::asio::io_context& context, const Config& config);
    ...
    boost::future<std::string> fetch_market_summary_async(const std::string& symbol) override;
    boost::future<std::vector<std::string>> fetch_all_market_summaries_async() override;
...
#endif // CCXT_ASYNC_TRADEOGRE_ASYNC_H
