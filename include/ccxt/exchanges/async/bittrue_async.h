#ifndef CCXT_BITTRUE_ASYNC_H
#define CCXT_BITTRUE_ASYNC_H
...
class BittrueAsync : public ExchangeAsync, public Bittrue {
public:
    explicit BittrueAsync(const boost::asio::io_context& context);
    ~BittrueAsync() = default;
