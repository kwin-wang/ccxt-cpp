#ifndef CCXT_ASYNC_HUOBI_ASYNC_H
#define CCXT_ASYNC_HUOBI_ASYNC_H
...
class HuobiAsync : public AsyncExchange, public huobi {
public:
    HuobiAsync(const boost::asio::io_context& context, const Config& config);
...
#endif // CCXT_ASYNC_HUOBI_ASYNC_H
