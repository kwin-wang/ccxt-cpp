#ifndef CCXT_ASYNC_BITCOINCOM_ASYNC_H
#define CCXT_ASYNC_BITCOINCOM_ASYNC_H

#include "../async_base/async_exchange.h"
#include "../bitcoincom.h"

namespace ccxt {

class BitcoincomAsync : public AsyncExchange, public bitcoincom {
public:
    BitcoincomAsync(const boost::asio::io_context& context, const Config& config);
...
#endif // CCXT_ASYNC_BITCOINCOM_ASYNC_H
