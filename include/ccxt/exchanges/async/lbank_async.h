#ifndef CCXT_ASYNC_LBANK_ASYNC_H
#define CCXT_ASYNC_LBANK_ASYNC_H
...
class LBankAsync : public AsyncExchange, public lbank {
public:
    LBankAsync(const boost::asio::io_context& context, const Config& config);
...
#endif // CCXT_ASYNC_LBANK_ASYNC_H
