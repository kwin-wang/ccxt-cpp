#ifndef CCXT_ASYNC_PHEMEX_ASYNC_H
#define CCXT_ASYNC_PHEMEX_ASYNC_H
...
class PhemexAsync : public AsyncExchange, public phemex {
public:
    PhemexAsync(const boost::asio::io_context& context, const Config& config);
...
#endif // CCXT_ASYNC_PHEMEX_ASYNC_H
