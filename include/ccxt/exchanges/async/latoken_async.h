#ifndef CCXT_ASYNC_LATOKEN_ASYNC_H
#define CCXT_ASYNC_LATOKEN_ASYNC_H
...
class LatokenAsync : public AsyncExchange, public latoken {
public:
    LatokenAsync(const boost::asio::io_context& context, const Config& config);
...
#endif // CCXT_ASYNC_LATOKEN_ASYNC_H
