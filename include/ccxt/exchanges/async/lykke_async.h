#ifndef CCXT_ASYNC_LYKKE_ASYNC_H
#define CCXT_ASYNC_LYKKE_ASYNC_H
...
class LykkeAsync : public AsyncExchange, public lykke {
public:
    LykkeAsync(const boost::asio::io_context& context, const Config& config);
    ...
    boost::future<std::vector<std::string>> fetch_orders_history_async(const std::optional<std::string>& symbol = std::nullopt,
                                                                     const std::optional<long long>& since = std::nullopt,
                                                                     const std::optional<int>& limit = std::nullopt);
    boost::future<std::string> fetch_order_trades_async(const std::string& id);
...
#endif // CCXT_ASYNC_LYKKE_ASYNC_H
