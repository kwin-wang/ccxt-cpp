#ifndef CCXT_ASYNC_HYPERLIQUID_ASYNC_H
#define CCXT_ASYNC_HYPERLIQUID_ASYNC_H
...
class HyperliquidAsync : public AsyncExchange, public hyperliquid {
public:
    HyperliquidAsync(const boost::asio::io_context& context, const Config& config);
...
#endif // CCXT_ASYNC_HYPERLIQUID_ASYNC_H
