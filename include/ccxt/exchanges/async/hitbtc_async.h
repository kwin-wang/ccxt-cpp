#ifndef CCXT_HITBTC_ASYNC_H
#define CCXT_HITBTC_ASYNC_H
...
class HitbtcAsync : public ExchangeAsync, public Hitbtc {
public:
    explicit HitbtcAsync(const boost::asio::io_context& context);
    ~HitbtcAsync() = default;
