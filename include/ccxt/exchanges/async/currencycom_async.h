#ifndef CCXT_EXCHANGES_ASYNC_CURRENCYCOM_ASYNC_H
#define CCXT_EXCHANGES_ASYNC_CURRENCYCOM_ASYNC_H
...
class CurrencyComAsync : public AsyncExchange, public currencycom {
public:
    explicit CurrencyComAsync(const boost::asio::io_context& context);
    ~CurrencyComAsync() override = default;
...
#endif // CCXT_EXCHANGES_ASYNC_CURRENCYCOM_ASYNC_H
