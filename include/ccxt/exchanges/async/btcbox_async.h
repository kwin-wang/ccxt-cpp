#ifndef CCXT_ASYNC_BTCBOX_ASYNC_H
#define CCXT_ASYNC_BTCBOX_ASYNC_H
...
class BTCBoxAsync : public AsyncExchange, public btcbox {
public:
    BTCBoxAsync(const boost::asio::io_context& context, const Config& config);
...
#endif // CCXT_ASYNC_BTCBOX_ASYNC_H
