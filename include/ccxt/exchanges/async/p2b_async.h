#ifndef CCXT_ASYNC_P2B_ASYNC_H
#define CCXT_ASYNC_P2B_ASYNC_H
...
class P2BAsync : public AsyncExchange, public p2b {
public:
    P2BAsync(const boost::asio::io_context& context, const Config& config);
