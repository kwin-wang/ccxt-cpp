#ifndef CCXT_BLOCKCHAINCOM_ASYNC_H
#define CCXT_BLOCKCHAINCOM_ASYNC_H
...
class BlockchaincomAsync : public ExchangeAsync, public Blockchaincom {
public:
    explicit BlockchaincomAsync(const boost::asio::io_context& context);
    ~BlockchaincomAsync() = default;
...
#endif // CCXT_BLOCKCHAINCOM_ASYNC_H
