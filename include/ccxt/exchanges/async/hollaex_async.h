#ifndef CCXT_EXCHANGES_ASYNC_HOLLAEX_ASYNC_H
#define CCXT_EXCHANGES_ASYNC_HOLLAEX_ASYNC_H
...
class HollaexAsync : public AsyncExchange, public hollaex {
public:
    explicit HollaexAsync(const boost::asio::io_context& context, const Config& config = Config());
    ~HollaexAsync() override = default;

    // Market Data API
    boost::future<std::vector<Market>> fetch_markets_async();
    boost::future<std::vector<Currency>> fetch_currencies_async();
...
#endif // CCXT_EXCHANGES_ASYNC_HOLLAEX_ASYNC_H
