#ifndef CCXT_ASYNC_KUCOIN_ASYNC_H
#define CCXT_ASYNC_KUCOIN_ASYNC_H
...
class KuCoinAsync : public AsyncExchange, public kucoin {
public:
    KuCoinAsync(const boost::asio::io_context& context, const Config& config);
...
#endif // CCXT_ASYNC_KUCOIN_ASYNC_H
