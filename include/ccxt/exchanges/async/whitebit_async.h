#ifndef CCXT_ASYNC_WHITEBIT_ASYNC_H
#define CCXT_ASYNC_WHITEBIT_ASYNC_H
...
class WhitebitAsync : public AsyncExchange, public whitebit {
public:
    WhitebitAsync(const boost::asio::io_context& context, const Config& config);
...
#endif // CCXT_ASYNC_WHITEBIT_ASYNC_H
