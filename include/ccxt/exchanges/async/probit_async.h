#ifndef CCXT_ASYNC_PROBIT_ASYNC_H
#define CCXT_ASYNC_PROBIT_ASYNC_H
...
class ProbitAsync : public AsyncExchange, public probit {
public:
    ProbitAsync(const boost::asio::io_context& context, const Config& config);
...
#endif // CCXT_ASYNC_PROBIT_ASYNC_H
