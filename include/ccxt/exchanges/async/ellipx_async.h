#ifndef CCXT_ASYNC_ELLIPX_ASYNC_H
#define CCXT_ASYNC_ELLIPX_ASYNC_H
...
class EllipxAsync : public AsyncExchange, public ellipx {
public:
    EllipxAsync(const boost::asio::io_context& context, const Config& config);
...
#endif // CCXT_ASYNC_ELLIPX_ASYNC_H
