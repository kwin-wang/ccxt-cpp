#ifndef CCXT_BITCMARKET_ASYNC_H
#define CCXT_BITCMARKET_ASYNC_H

#include "ccxt/exchanges/async/exchange_async.h"
#include "ccxt/exchanges/bitcmarket.h"

namespace ccxt {

class BitcmarketAsync : public ExchangeAsync, public Bitcmarket {
public:
    explicit BitcmarketAsync(const boost::asio::io_context& context);
    ~BitcmarketAsync() = default;
