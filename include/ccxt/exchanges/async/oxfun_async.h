#ifndef CCXT_ASYNC_OXFUN_ASYNC_H
#define CCXT_ASYNC_OXFUN_ASYNC_H
...
class OxfunAsync : public AsyncExchange, public oxfun {
public:
    OxfunAsync(const boost::asio::io_context& context, const Config& config);
...
#endif // CCXT_ASYNC_OXFUN_ASYNC_H
