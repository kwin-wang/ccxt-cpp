#ifndef CCXT_ASYNC_KUCOINFUTURES_ASYNC_H
#define CCXT_ASYNC_KUCOINFUTURES_ASYNC_H
...
class KuCoinFuturesAsync : public AsyncExchange, public kucoinfutures {
public:
    KuCoinFuturesAsync(const boost::asio::io_context& context, const Config& config);
...
#endif // CCXT_ASYNC_KUCOINFUTURES_ASYNC_H
