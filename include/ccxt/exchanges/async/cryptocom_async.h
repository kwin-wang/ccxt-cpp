#ifndef CCXT_ASYNC_CRYPTOCOM_ASYNC_H
#define CCXT_ASYNC_CRYPTOCOM_ASYNC_H
...
class CryptocomAsync : public AsyncExchange, public cryptocom {
public:
    CryptocomAsync(const boost::asio::io_context& context, const Config& config);
    ...
    boost::future<std::vector<std::string>> fetch_funding_rates_async(const std::vector<std::string>& symbols = {});
    boost::future<std::vector<std::string>> fetch_funding_history_async(const std::optional<std::string>& symbol = std::nullopt,
                                                                      const std::optional<long long>& since = std::nullopt,
                                                                      const std::optional<int>& limit = std::nullopt);
    boost::future<std::vector<std::string>> fetch_positions_async(const std::optional<std::vector<std::string>>& symbols = std::nullopt,
                                                                const std::optional<long long>& since = std::nullopt,
                                                                const std::optional<int>& limit = std::nullopt);
    boost::future<std::vector<std::string>> fetch_leverage_tiers_async(const std::vector<std::string>& symbols = {});
    boost::future<std::string> set_leverage_async(double leverage,
                                                const std::string& symbol);
    boost::future<std::string> set_margin_mode_async(const std::string& marginMode,
                                                    const std::string& symbol);
...
#endif // CCXT_ASYNC_CRYPTOCOM_ASYNC_H
