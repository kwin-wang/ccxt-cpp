#ifndef CCXT_ASYNC_PAYMIUM_ASYNC_H
#define CCXT_ASYNC_PAYMIUM_ASYNC_H
...
class PaymiumAsync : public AsyncExchange, public paymium {
public:
    PaymiumAsync(const boost::asio::io_context& context, const Config& config);
    ...
    boost::future<std::vector<std::string>> fetch_transactions_async(const std::optional<std::string>& code = std::nullopt,
                                                                   const std::optional<long long>& since = std::nullopt,
                                                                   const std::optional<int>& limit = std::nullopt);
    boost::future<std::string> fetch_market_depth_async(const std::string& symbol);
...
#endif // CCXT_ASYNC_PAYMIUM_ASYNC_H
