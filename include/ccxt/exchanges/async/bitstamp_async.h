#ifndef CCXT_BITSTAMP_ASYNC_H
#define CCXT_BITSTAMP_ASYNC_H
...
class BitstampAsync : public ExchangeAsync, public Bitstamp {
public:
    explicit BitstampAsync(const boost::asio::io_context& context);
    ~BitstampAsync() = default;
    ...
    boost::future<json> fetchTransactionsAsync(const String& code = "", int since = 0,
                                             int limit = 0, const json& params = json::object());
    boost::future<json> fetchLedgerAsync(const String& code = "", int since = 0,
                                       int limit = 0, const json& params = json::object());
};

} // namespace ccxt

#endif // CCXT_BITSTAMP_ASYNC_H
