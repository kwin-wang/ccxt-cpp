#ifndef CCXT_ASYNC_WAZIRX_ASYNC_H
#define CCXT_ASYNC_WAZIRX_ASYNC_H
...
class WazirXAsync : public AsyncExchange, public wazirx {
public:
    WazirXAsync(const boost::asio::io_context& context, const Config& config);
    ...
    boost::future<std::string> fetch_market_status_async(const std::string& symbol);
    boost::future<std::vector<std::string>> fetch_order_trades_async(const std::string& id,
                                                                   const std::string& symbol);
    boost::future<std::string> fetch_market_info_async(const std::string& symbol);
...
#endif // CCXT_ASYNC_WAZIRX_ASYNC_H
