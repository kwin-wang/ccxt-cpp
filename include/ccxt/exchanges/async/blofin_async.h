#ifndef CCXT_BLOFIN_ASYNC_H
#define CCXT_BLOFIN_ASYNC_H
...
class BlofinAsync : public ExchangeAsync, public Blofin {
public:
    explicit BlofinAsync(const boost::asio::io_context& context);
    ~BlofinAsync() = default;
    ...
    boost::future<json> fetchLeverageAsync(const String& symbol,
                                         const json& params = json::object());
