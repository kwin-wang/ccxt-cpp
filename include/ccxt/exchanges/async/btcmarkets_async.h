#ifndef CCXT_ASYNC_BTCMARKETS_ASYNC_H
#define CCXT_ASYNC_BTCMARKETS_ASYNC_H
...
class BTCMarketsAsync : public AsyncExchange, public btcmarkets {
public:
    BTCMarketsAsync(const boost::asio::io_context& context, const Config& config);
    ...
    boost::future<std::string> fetch_market_summary_async(const std::string& symbol);
...
#endif // CCXT_ASYNC_BTCMARKETS_ASYNC_H
