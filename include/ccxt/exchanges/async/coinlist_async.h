#ifndef CCXT_EXCHANGES_ASYNC_COINLIST_ASYNC_H
#define CCXT_EXCHANGES_ASYNC_COINLIST_ASYNC_H
...
class CoinlistAsync : public AsyncExchange, public coinlist {
public:
    explicit CoinlistAsync(const boost::asio::io_context& context);
    ~CoinlistAsync() override = default;
...
#endif // CCXT_EXCHANGES_ASYNC_COINLIST_ASYNC_H
