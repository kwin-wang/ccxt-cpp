#ifndef CCXT_ASYNC_OKX_ASYNC_H
#define CCXT_ASYNC_OKX_ASYNC_H
...
class OkxAsync : public AsyncExchange, public okx {
public:
    OkxAsync(const boost::asio::io_context& context, const Config& config);
