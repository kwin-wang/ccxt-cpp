#ifndef CCXT_ASYNC_HUOBIJP_ASYNC_H
#define CCXT_ASYNC_HUOBIJP_ASYNC_H
...
class HuobiJPAsync : public AsyncExchange, public huobijp {
public:
    HuobiJPAsync(const boost::asio::io_context& context, const Config& config);
...
#endif // CCXT_ASYNC_HUOBIJP_ASYNC_H
