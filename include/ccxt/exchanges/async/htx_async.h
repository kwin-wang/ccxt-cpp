#ifndef CCXT_ASYNC_HTX_ASYNC_H
#define CCXT_ASYNC_HTX_ASYNC_H
...
class HTXAsync : public AsyncExchange, public htx {
public:
    HTXAsync(const boost::asio::io_context& context, const Config& config);
