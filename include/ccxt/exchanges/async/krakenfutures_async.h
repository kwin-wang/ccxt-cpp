#ifndef CCXT_ASYNC_KRAKENFUTURES_ASYNC_H
#define CCXT_ASYNC_KRAKENFUTURES_ASYNC_H
...
class KrakenFuturesAsync : public AsyncExchange, public krakenfutures {
public:
    KrakenFuturesAsync(const boost::asio::io_context& context, const Config& config);
...
#endif // CCXT_ASYNC_KRAKENFUTURES_ASYNC_H
