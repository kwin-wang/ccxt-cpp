#ifndef CCXT_ASYNC_MEXC_ASYNC_H
#define CCXT_ASYNC_MEXC_ASYNC_H
...
class MexcAsync : public AsyncExchange, public mexc {
public:
    MexcAsync(const boost::asio::io_context& context, const Config& config);
