#ifndef CCXT_ASYNC_MERCADO_ASYNC_H
#define CCXT_ASYNC_MERCADO_ASYNC_H
...
class MercadoAsync : public AsyncExchange, public mercado {
public:
    MercadoAsync(const boost::asio::io_context& context, const Config& config);
...
#endif // CCXT_ASYNC_MERCADO_ASYNC_H
