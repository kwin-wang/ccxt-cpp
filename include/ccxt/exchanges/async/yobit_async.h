#ifndef CCXT_ASYNC_YOBIT_ASYNC_H
#define CCXT_ASYNC_YOBIT_ASYNC_H
...
class YobitAsync : public AsyncExchange, public yobit {
public:
    YobitAsync(const boost::asio::io_context& context, const Config& config);
...
#endif // CCXT_ASYNC_YOBIT_ASYNC_H
