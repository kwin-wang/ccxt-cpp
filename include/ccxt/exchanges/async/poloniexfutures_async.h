#ifndef CCXT_ASYNC_POLONIEXFUTURES_ASYNC_H
#define CCXT_ASYNC_POLONIEXFUTURES_ASYNC_H

#include "../async_base/async_exchange.h"
#include "../poloniexfutures.h"

namespace ccxt {

class PoloniexFuturesAsync : public AsyncExchange, public poloniexfutures {
public:
    PoloniexFuturesAsync(const boost::asio::io_context& context, const Config& config);
...
#endif // CCXT_ASYNC_POLONIEXFUTURES_ASYNC_H
