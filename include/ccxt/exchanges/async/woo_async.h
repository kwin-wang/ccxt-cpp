#ifndef CCXT_ASYNC_WOO_ASYNC_H
#define CCXT_ASYNC_WOO_ASYNC_H
...
class WooAsync : public AsyncExchange, public woo {
public:
    WooAsync(const boost::asio::io_context& context, const Config& config);
