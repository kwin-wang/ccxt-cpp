#ifndef CCXT_ASYNC_IDEX_ASYNC_H
#define CCXT_ASYNC_IDEX_ASYNC_H
...
class IDEXAsync : public AsyncExchange, public idex {
public:
    IDEXAsync(const boost::asio::io_context& context, const Config& config);
