#ifndef CCXT_ASYNC_OKCOIN_ASYNC_H
#define CCXT_ASYNC_OKCOIN_ASYNC_H
...
class OKCoinAsync : public AsyncExchange, public okcoin {
public:
    OKCoinAsync(const boost::asio::io_context& context, const Config& config);
...
#endif // CCXT_ASYNC_OKCOIN_ASYNC_H
