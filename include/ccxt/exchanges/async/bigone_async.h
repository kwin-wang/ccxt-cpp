#ifndef CCXT_ASYNC_BIGONE_ASYNC_H
#define CCXT_ASYNC_BIGONE_ASYNC_H
...
class BigoneAsync : public AsyncExchange, public bigone {
public:
    BigoneAsync(const boost::asio::io_context& context, const Config& config);
...
#endif // CCXT_ASYNC_BIGONE_ASYNC_H
