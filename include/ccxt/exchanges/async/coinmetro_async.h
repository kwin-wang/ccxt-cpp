#ifndef CCXT_ASYNC_COINMETRO_ASYNC_H
#define CCXT_ASYNC_COINMETRO_ASYNC_H
...
class CoinmetroAsync : public AsyncExchange, public coinmetro {
public:
    CoinmetroAsync(const boost::asio::io_context& context, const Config& config);
    ...
    boost::future<std::vector<std::string>> fetch_trading_limits_async(const std::vector<std::string>& symbols = {});
    boost::future<std::string> fetch_transaction_fees_async(const std::string& code);
...
#endif // CCXT_ASYNC_COINMETRO_ASYNC_H
