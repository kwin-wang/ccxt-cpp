...
public:
    ...
    json fetchMarketLeverageTiers(const std::string& symbol, const json& params = json::object());
...
private:
    ...
    std::string getProbitSymbol(const std::string& symbol);
    std::string getCommonSymbol(const std::string& probitSymbol);
